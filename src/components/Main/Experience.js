...
export default () =>
  <div className="main-grid">
    <section className="three">
      ...
      <ul className="list-experience">
        ...
        <li>
          ...
          <p className="work-location">
            MidNorthern Marketing LLC, Minneapolis, MN
            </p>
    ...
    <section className="four">
      ...
      <ul className="list-experience">
        <li>
          <h3 className="work-role">Full Stack Web Development</h3>
          <p className="work-location">University of Minnesota Coding Bootcamp</p>
          <p className="work-duration">Feb - July 2018</p>
        </li>
        <li>
          <h3 className="work-role">
            BS in Residential Building Science & Technology
            </h3>
          <p className="work-location">University of Minnesota - Twin Cities</p>
          <p className="work-duration">Sep 2011 - May 2015</p>
        </li>
      </ul>
    </section>
  </div>